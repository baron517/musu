...
Page({
    ...
    loadData: function() {
                ...
                if (res.code == 0) {
                    if (res.data.status == 'diy') {
                        ...
                        for (var i = act_modal_list.length - 1; i >= 0; i--) {
                            if ((typeof act_modal_list[i].status == 'undefined' || act_modal_list[i].status == 0) && getApp().helper.inArray(act_modal_list[i].page_id, page_first) && !self.data.user_info_show) {
        ...
        getApp().request({
            url: getApp().api.default.catTypeList,
            success: function (res) {
                ...
                if(res.code==0)
                {
                    ...
                    console.log(self.data.home_list);
                }
